...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-bihar"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Bihar - Me Bhi Neta</title>
    <meta name="Description" content="Get All about Members of Members of Legislative Assembly Bihar at Me Bhi Neta."/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/bihar-me-bhi-neta.jpg" alt="member-of-legislative-assembly-bihar" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Bihar</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Singh, Shri Gopal Narayan</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Jethmalani, Shri Ram</td>
                                <td>RJD</td>
                            </tr>
                            ...
                            <tr>
                                <td>5</td>
                                <td>Sinha, Shri R. K</td>
                                <td>BJP </td>
                            </tr>

                            <tr>
                                <td>6</td>
                                <td>Harivansh, Shri</td>
                                <td>JD(U)</td>
                            </tr>

                            <tr>
                                <td>7</td>
                                <td>Pradhan, Shri Dharmendra</td>
                                <td>BJP </td>
                            </tr>

                            <tr>
                                <td> 8</td>
                                <td>Bharti, Smt. Misha</td>
                                <td>RJD  </td>
                            </tr>

                            <tr>
                                <td>9 </td>
                                <td>Mahendra Prasad, Dr </td>
                                <td>JD(U) </td>
                            </tr>

                            <tr>
                                <td>10</td>
                                <td>Singh, Shri Bashistha Narain  </td>
                                <td>JD(U) </td>
                            </tr>
                            ...
                            <tr>
                                <td>13</td>
                                <td>Perween, Smt. Kahkashan </td>
                                <td>JD(U) </td>
                            </tr>

                            <tr>
                                <td>14</td>
                                <td>Singh, Shri Ram Chandra Prasad </td>
                                <td>JD(U) </td>
                            </tr>

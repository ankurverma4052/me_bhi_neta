...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-chhattisgarh"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Chhttisgarh - Me Bhi Neta</title>
    <meta name="Description" content="Know about Members of Members of Legislative Assembly Chhttisgarh at Me Bhi Neta."/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/chhastisgarh-me-bhi-neta.jpg" alt="member-of-legislative-assembly-chhattisgarh" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Chhattisgarh</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Jangde, Dr. Bhushan Lal</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Vora, Shri Motilal</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Netam, Shri Ram Vichar</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Judev, Shri Ranvijay Singh</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>5</td>
                                <td>Verma, Smt. Chhaya</td>
                                <td>INC </td>
                            </tr>

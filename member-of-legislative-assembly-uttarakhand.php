...
<head>  
   <meta charset="utf-8">  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-uttarakhand"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Uttarakhand - Me Bhi Neta</title>
    <meta name="Description" content="Get to know the MLA list of all the Members of Legislative Assembly Uttarakhand  available on Me Bhi Neta with their biodata"/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/uttrakhand-me-bhi-neta.jpg" alt="member-of-legislative-assembly-urrarakhand" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Uttarakhand</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Tamta, Shri Pradeep</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Babbar, Shri Raj</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Mahra, Shri Mahendra Singh</td>
                                <td>INC </td>
                            </tr>

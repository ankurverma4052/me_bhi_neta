...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-arunachal-pradesh"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Arunachal Pradesh - Me Bhi Neta</title>
    <meta name="Description" content="Get Information All about Members of Members of Legislative Assembly Arunachal Pradesh at Me Bhi Neta this is the"/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/arunachal-pradesh-me-bhi-neta.jpg" alt="member-of-legislative-assembly-arunachal-pradesh" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Arunachal Pradesh</h1>
            <div id="margin-line">
                </div> <br>

...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-andhra-pradesh"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Andhra Pradesh - Me Bhi Neta</title>
    <meta name="Description" content="Get Information All about Members of Legislative Assembly Andhra Pradesh at Me Bhi Neta this is the" />
...
<!-- Navigation End -->
	...
	<section>
		...
		<img src="image/andhra-pradesh-me-bhi-neta.jpg" alt="member-of-legislative-assembly-andhra-pradesh" class="img-responsive" style="margin-top: -21px;">
...
<div class="container">
	<div class="col-md-10 col-xs-12">
		<h1 id="servicehead1">Member of Legislative Assembly Andhra Pradesh</h1>
			<div id="margin-line">
				</div> <br>
			...
			<div class="col-md-10">
				<table style="width:100%;">
							...
							<tr style="background-color: #69332f; color: #ffffff;">
						 	...
						 	<tr>
						 		<td>1 </td>
						 		<td>Chowdhury, Smt. Renuka </td>
						 		<td> INC </td>
						 	</tr>

						 	<tr>
						 		<td>2 </td>
						 		<td>Reddy, Dr. T. Subbarami  </td>
						 		<td>INC  </td>
						 	</tr>
						 	<tr>
						 		<td>3 </td>
						 		<td>Rao, Dr. K. Keshava </td>
						 		<td> TRS </td>
						 	</tr>
						 	<tr>
						 		<td>4 </td>
						 		<td>Khan, Shri Mohd. Ali </td>
						 		<td>INC  </td>
						 	</tr>
						 	<tr>
						 		<td>5 </td>
						 		<td>Chowdary, Shri Y. S </td>
						 		<td> TDP </td>
						 	</tr>
						 	<tr>
						 		<td>6 </td>
						 		<td>Chiranjeevi, Dr. K </td>
						 		<td>INC  </td>
						 	</tr>
						 	<tr>
						 		<td>7 </td>
						 		<td>Goud T., Shri Devender </td>
						 		<td>TDP  </td>
						 	</tr>
						 	<tr>
						 		<td>8 </td>
						 		<td>Seetharama Lakshmi, Smt. Thota </td>
						 		<td>TDP  </td>
						 	</tr>
						 	<tr>
						 		<td>9 </td>
						 		<td>Prabhu, Shri Suresh </td>
						 		<td> BJP </td>
						 	</tr>
						 	<tr>
						 		<td>10 </td>
						 		<td>Venkatesh, Shri T.G </td>
						 		<td>TDP  </td>
						 	</tr>
						 	<tr>
						 		<td>11 </td>
						 		<td>Reddy, Shri V. Vijayasai </td>
						 		<td>YSRCP  </td>
						 	</tr>

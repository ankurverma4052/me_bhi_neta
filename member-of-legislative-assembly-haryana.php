...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-haryana"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Haryana - Me Bhi Neta</title>
    <meta name="Description" content="If you Know about Members of Members of Legislative Assembly Haryana Then you are at right place Me Bhi Neta."/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/haryana-me-bhi-neta.jpg" alt="member-of-legislative-assembly-haryana" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Haryana</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Singh, Chaudhary Birender</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Kashyap, Shri Ram Kumar</td>
                                <td>INLD</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Subhash Chandra, Dr</td>
                                <td>IND</td>
                            </tr>

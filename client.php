...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/client"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Client - Me Bhi Neta</title>
    <meta name="description" content="Read our portfolio and about Me Bhi Neta Client Section and Reviews." />
...
<section>
	...
	<img src="image/clients-me-bhi-neta.jpg" alt="client" class="img-responsive" style="margin-top: -20px; width: 1504px; height: 400px;">

	
</section>

<h1 id="clienthead">Our Clients</h1>

	<div class="container">
		<div class="col-md-8 col-xs-12" id="client">
			<div class="col-md-8 ">
				<ul >

					<li>&nbsp;&nbsp;&nbsp; 	Bharatiya Janata Party (BJP)</li>
					<li>&nbsp;&nbsp;&nbsp; 	Indian National Congress (INC)</li>
					<li>&nbsp;&nbsp;&nbsp;  Bahujan Samaj Party (BSP)</li>
					<li>&nbsp;&nbsp;&nbsp; 	All India Trinamool Congress (AITC)</li>
					<li>&nbsp;&nbsp;&nbsp; 	Communist Party of India (CPI)</li>
					<li>&nbsp;&nbsp;&nbsp;  Communist Party of India (Marxist)(CPI-M)</li>
					<li>&nbsp;&nbsp;&nbsp; 	Nationalist Congress Party (NCP)</li>
					<li>&nbsp;&nbsp;&nbsp;  Samajwadi Party (SP)</li>
					<li>&nbsp;&nbsp;&nbsp;  Aam Aadmi Party (AAP)</li>
					<li>&nbsp;&nbsp;&nbsp;  Biju Janata Dal(BJD)</li>
					<li>&nbsp;&nbsp;&nbsp;  Janata Dal (United) (JD(U))</li>
					<li>&nbsp;&nbsp;&nbsp;  Lok Janshakti Party (LJP)</li>
					<li>&nbsp;&nbsp;&nbsp;  Maharashtra Navnirman Sena (MNS)</li>
					<li>&nbsp;&nbsp;&nbsp;  Rashtriya Janata Dal (RJD)</li>
					<li>&nbsp;&nbsp;&nbsp;  Rashtriya Lok Dal(RLD)</li>
					<li>&nbsp;&nbsp;&nbsp; 	Shiromani Akali Dal (SAD)</li>
					<li>&nbsp;&nbsp;&nbsp; 	Shiv Sena (SS)</li>
					<li>&nbsp;&nbsp;&nbsp;  Telangana Rashtra Samithi (TRS)</li>
					<li>&nbsp;&nbsp;&nbsp;  Telugu Desam Party (TDP)</li>
					<li>&nbsp;&nbsp;&nbsp;  YSR Congress Party (YSRCP)</li>
					<li>&nbsp;&nbsp;&nbsp;  Indian National Lok Dal (INDL)</li>
					<li>&nbsp;&nbsp;&nbsp;  Jammu &amp; Kashmir National Conference (JKNC)</li>
					<li>&nbsp;&nbsp;&nbsp;  Jammu and Kashmir People's Democratic Party (JKPDP)</li>
					<li>&nbsp;&nbsp;&nbsp;  Jharkhand Mukti Morcha (JMM)</li>

...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/mbn-feeds"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Breaking News | Aj ki Taja Khabar |  - Me Bhi Neta</title>
    <meta name="Description" content="Breaking News, Aj Ki Taja khabar available on Me Bhi Neta  and Sharing latest political, election trending news."/>
...
<div class="bgimg" style="margin-top: -21px;">
  
  <div class="middle">

  <h1>MBN Feed</h1><br/>

    <h2 class="animated infinite flash">COMING SOON</h2><br/>
    <hr>

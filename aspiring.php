        ...
        <div class="page-content container-fluid">
          <div class="widget">
            ...
            <div class="widget-body">
              <form id="form-vertical" method="post" novalidate="novalidate" action="aspiring_insert" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <textarea id="containt" name="containt" placeholder="write Containt" data-rule-required="true" data-rule-rangelength="[20,10000]" data-rule-text="true" class="form-control"></textarea>
                </div>

...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/public-relations"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Public Relations (PR) - Me Bhi Neta</title>
    <meta name="Description" content=" Me Bhi Neta is leading Public Relations (PR) Agency in Delhi NCR India. If you are looking PR related service then contact us."/>
...
<!-- Navigation End -->
	...
	<section>
		...
		<img src="image/public-relations-me-bhi-neta.jpg" alt="public-relations" id="picture" style="margin-top: -20px; width: 1504px; height: 400px;">
...
<div class="container">
	...
	<div class="col-md-10 col-xs-12">
		<h1 id="servicehead1">Public Relations</h1>
			
			<div id="margin-line">
				</div> <br>
		<section id="servicepara">

			<p>The initial form of public relations known to mankind in politics consisted of ancient leaders creating monuments promoting their reign or spreading rumors and lies about an enemy. But when mass communication arrived, politicians running for office truly had an opportunity to influence others for the first time. Politics and public relations have had a close nexus and here comes the role of PR teams and agencies. So, <Strong>Me Bhi Neta</Strong> being fully aware of the importance of maintaining a good relationship with the public in this technologically fast moving world. Especially if you are contesting an election.</p>

		<h2 id="servicehead2">Our Team</h2>

			<p><strong>Me Bhi Neta</strong> will serve with a world-class PR team with ample of experience and qualities in their respective fields. Our team will guide each of your step in public relation management. Our team is full of creativity and unique ideas which surely will give your public relation management an edge over your competitors.</p>

		<h2 id="servicehead2">Strategic Messaging &amp; Timeline</h2>
			<p>While managing PR in political campaigning, it becomes necessary that you are consistent with your efforts in maintaining that relationship with the public. And to achieve that goal, strategic messaging and timeline maintenance can be a key to success. We have experience and experts sitting with <strong>Me Bhi Neta</strong> who will make sure that your message is being delivered accurately at a correct time and pace. We will also make sure to prevent from negative imaging in public. With us, you share the best of bond with people who will understand the loyalty and intention of your self.</p>

		<h2 id="servicehead2">Crisis Communication </h2>
			<p>Encountering crisis while political campaigning is not an exception neither is it new. But the thing/firm/technique which can handle it smoothly and without damaging your image is new. Me Bhi Neta has experience as well as expertise in the situation of crisis and we will not let that tiny part of journey damage your whole campaign.</p>

...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/list-of-assembly-constituency-in-india"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>List of Assembly Constituency in India - Me Bhi Neta</title>
    <meta name="Description" content="Indian assembly constituency List, List of assembly constituency, Assembly constituency list, State wise list of assembly, Complete list of assembly constituency in India, vidhan sabaha List, List of AC , list of assembly constituency name and no." />
...
<section>
		...
		<img src="image/assembly-constituency-me-bhi-neta.jpg" alt="assembly-constituency" class="img-responsive" style="margin-top: -20px; width: 1504px; height: 400px;">
		
</section>

<div class="container">
	<div class="col-md-8 col-xs-12">
		<h1 id="servicehead1">List of Assembly Constituency in India</h1>
			<div id="margin-line">
				</div> <br>
			...
			<div class="col-md-10">
				<table style="width:100%;">
					<tr>
						...
						<th colspan="4" style="background-color: #69332f; color: #ffffff;"><center>State wise parliament Constituency List</center></th>
					</tr>
						<tr style="background-color: #9E9E9E; color: #ffffff;">
						  	<td>No.</th>
						  	<td><center>State</center></th>
						  	<td><center>Capital</center></th>
						  	<td><center>Seats</center></th>
						</tr>
						...
						<tr style="background-color: #9E9E9E; color: #ffffff;">
						  	<td>No.</th>
						  	<td><center>Union Territories</center></th>
						  	<td><center>Capital</center></th>
						  	<td><center>Seats</center></th>
						</tr>

...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-council-telangana"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Member of Legislative Council Telangana - Me Bhi Neta</title>
    <meta name="Description" content="Member of Legislative Council Telangana list available on Me Bhi Neta with their all information about their career if you like our information then share it."/>
...
<!-- Navigation End -->
	...
	<section>
		...
		<img src="image/telangana-me-bhi-neta.jpg" alt="member-of-legislative-council-telangana" class="img-responsive" style="margin-top: -21px;">

	</section>

<div class="container">
	<div class="col-md-10 col-xs-12">
		<h1 id="servicehead1">Member of Legislative Council Telangana</h1>
			<div id="margin-line">
				</div> <br>
			...
			<div class="col-md-10">
				<table style="width:100%;">
						<tr style="background-color: #69332f; color: #ffffff;">
						  	<td>S No.</td>
						  	<td><center>MLC Seat</center></td>
						  	<td><center>Party</center></td>
							<td><center>Won</center></td>
						...
						<tr>
							...
							<td>Mahabubnagar </td>
							<td>TRS</td>
							<td>Kasireddy Narayana Reddy </td>

...
<head>  
    ...
    <meta property="og:description"  content="A Veteran of Vivid Personality & Political Experience" />
    ...
    return base64_decode(strtr($input, '-_,', '+/='));
		...
		$result=$mysqli->query("select * from prominent_leaders where id='".base64_url_decode($_GET['ids'])."'");
...
<section>
	...
	<img src="uploadsr/<?php echo $row['img']; ?>" alt="<?php echo $row['title']; ?>" class="img-responsive" style="margin-top: -20px; width: 1504px; height: 400px;">
...
<div class="container">
	<div class="col-md-8 col-xs-12">
		<h1 id="servicehead1">Prominent Leaders</h1>

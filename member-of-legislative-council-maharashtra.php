...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-council-maharashtra"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Member of Legislative Council Maharashtra - Me Bhi Neta</title>
    <meta name="Description" content="Member of Legislative Council Maharashtra list available on Me Bhi Neta with their all information about their career if you like our information then share it."/>
...
<!-- Navigation End -->
	...
	<section>
		...
		<img src="image/maharashtra-me-bhi-neta.jpg" alt="member-of-legislative-council-maharashtra" class="img-responsive" style="margin-top: -21px;">

	</section>
	
<div class="container">
	<div class="col-md-10 col-xs-12">
		<h1 id="servicehead1">Member of Legislative Council Maharashtra</h1>
			<div id="margin-line">
				</div> <br>
			...
			<div class="col-md-10">
				<table style="width:100%;">
						...
						<tr style="background-color: #69332f; color: #ffffff;">
						  	<td>LAC</td>
						  	<td><center>Winner</center></td>
						  	<td><center>Party</center></td>
						  	
						</tr>

						<tr>
							<td>Mumbai Local Authorities (1)</td>
							<td> Ramdas Kadam</td>
							<td>Shiv Sena</td>
						</tr>
						<tr>
							<td>Mumbai Local Authorities (2)</td>
							<td>Bhai Jagtap</td>
							<td>Indian National Congress</td>
						</tr>
						<tr>
							<td>Dhule-cum-Nandurbar Local Authorities</td>
							<td> Amrish Patel</td>
							<td>-</td>
						</tr>
						<tr>
							<td>Nagpur Local Authorities</td>
							<td>Girish Vyas</td>
							<td>Bharatiya Janata Party</td>
						</tr>
						<tr>
							<td>Ahmednagar Local Authorities</td>
							<td> Arun Jagtap</td>
							<td>Indian National Congress</td>
						</tr>
						<tr>
							<td>Solapur Local Authorities</td>
							<td> Prashant Paricharak</td>
							<td>Independent</td>
						</tr>
						<tr>
							<td>Kolhapur Local Authorities</td>
							<td>Satej Patil</td>
							<td>Indian National Congress</td>
						</tr>
						<tr>
							<td>Akola-cum-Washim-cum-Buldhana Local Authorities</td>
							<td>Gopikishan Bajoria</td>
							<td>Shiv Sena</td>
						</tr>

...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-punjab"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Punjab - Me Bhi Neta</title>
    <meta name="Description" content="Get to know the list of all the MLA ( Members of Legislative Assembly ) Punjab at Me Bhi Neta and their constituencies and their partie"/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/punjab-me-bhi-neta.jpg" alt="member-of-legislative-assembly-punjab" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Punjab</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Bajwa, Shri Partap Singh</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Dullo, Shri Shamsher Singh</td>
                                <td> INC</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Dhindsa, Sardar Sukhdev Singh</td>
                                <td>SAD </td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Gujral, Shri Naresh</td>
                                <td>SAD </td>
                            </tr>

                            <tr>
                                <td>5</td>
                                <td>Malik, Shri Shwait</td>
                                <td>BJP</td>
                            </tr>

                             <tr>
                                <td>6</td>
                                <td>Bhunder, Sardar Balwinder Singh</td>
                                <td>SAD </td>
                            </tr>

                             <tr>
                                <td>7</td>
                                <td>Soni, Smt. Ambika</td>
                                <td>INC</td>
                            </tr>

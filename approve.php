            ...
            <div class="widget-body">
              ...
              <table id="product-list" style="width: 100%" class="table table-hover dt-responsive nowrap">
                ...
                <tbody>
                    ...
                    $result=$mysqli->query("select * from usercon");
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <?php echo '<button type="button" id="d'.$row['id'].'" value="'.$row['id'].'" class="btn btn-outline btn-danger"><i class="ti-trash"></i></button>'; ?>

                      <?php echo '<button type="button" id="a'.$row['id'].'" value="'.$row['id'].'" class="btn btn-outline btn-success"><i class="ti-upload"></i></button>'; ?>

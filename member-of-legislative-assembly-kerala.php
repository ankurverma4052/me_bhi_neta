...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-kerala"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Kerala - Me Bhi Neta</title>
    <meta name="Description" content="Members of Legislative Assembly Kerala List Available at Me Bhi Neta with all information about MLA."/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/kerela-me-bhi-neta.jpg" alt="member-of-legislative-assembly-kerala" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Kerala</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Ravi, Shri Vayalar</td>
                                <td>INC </td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Kurien, Prof. P.J</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Narayanan, Shri C.P.</td>
                                <td>CPI(M)</td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Veerendra Kumar, Shri M.P.</td>
                                <td>JD(U)</td>
                            </tr>

                            <tr>    
                                <td>5</td>
                                <td>Ragesh, Shri K.K.</td>
                                <td>CPI(M)</td>
                            </tr>

                            <tr>    
                                <td>6</td>
                                <td>Antony, Shri A.K</td>
                                <td>INC </td>
                            </tr>

                            <tr>    
                                <td>7</td>
                                <td>Abdul Wahab, Shri</td>
                                <td>IUML </td>
                            </tr>

                            <tr>    
                                <td>8</td>
                                <td>Abraham, Shri Joy</td>
                                <td>KC(M)</td>
                            </tr>

                            <tr>    
                                <td>9</td>
                                <td>Somaprasad, Shri K</td>
                                <td>CPI(M) </td>
                            </tr>

...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-jharkhand"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Jharkhand - Me Bhi Neta</title>
    <meta name="Description" content="If you Know about  Members of Legislative Assembly Jharkhand Then you are at right place Me Bhi Neta."/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/jharkhand-me-bhi-neta.jpg" alt="member-of-legislative-assembly-jharkhand" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Jharkhand</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Gupta, Shri Prem Chand</td>
                                <td>RJD </td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Nathwani, Shri Parimal</td>
                                <td>IND</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Sanjiv Kumar, Shri</td>
                                <td>JMM </td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Naqvi, Shri Mukhtar Abbas</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>5</td>
                                <td>Balmuchu, Dr. Pradeep Kumar</td>
                                <td>INC </td>
                            </tr>

                            <tr>
                                <td>6</td>
                                <td>Poddar, Shri Mahesh</td>
                                <td>BJP </td>
                            </tr>

...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-meghalaya"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Meghalaya - Me Bhi Neta</title>
    <meta name="Description" content="List of Members of Legislative Assembly Meghalaya  available at Me Bhi Neta. If you know about Me Bhi Neta then visit us."/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/meghalaya-me-bhi-neta.jpg" alt="member-of-legislative-assembly-meghalaya" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Meghalaya</h1>
            <div id="margin-line">
                </div> <br>

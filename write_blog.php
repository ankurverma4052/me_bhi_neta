        ...
        <div class="page-content container-fluid">
          <div class="widget">
            ...
            <div class="widget-body">
              <form id="form-vertical" method="post" novalidate="novalidate" action="inswrite" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="txttitle">Title</label>
                  <input id="txttitle" type="text" name="txttitle" placeholder="Enter Title" data-rule-required="true" data-rule-rangelength="[10,200]" data-rule-text="true" class="form-control">
                </div>

...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-assam"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Assam - Me Bhi Neta</title>
    <meta name="Description" content="Get Information All about Members of Members of Legislative Assembly Assam at Me Bhi Neta this is the"/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/assam-me-bhi-neta.jpg" alt="member-of-legislative-assembly-assam" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Assam</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Daimary, Shri Biswajit</td>
                                <td>BPF </td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Kalita, Shri Bhubaneswar</td>
                                <td>INC </td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Narah, Smt. Ranee</td>
                                <td>INC </td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Kujur, Shri Santiuse</td>
                                <td>INC </td>
                            </tr>

                            <tr>
                                <td>5</td>
                                <td>Sinh, Dr. Sanjay</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>6</td>
                                <td>Singh, Dr. Manmohan</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>7</td>
                                <td>Bora, Shri Ripun </td>
                                <td>INC</td>
                            </tr>
                    </table> <br/>
            </div>

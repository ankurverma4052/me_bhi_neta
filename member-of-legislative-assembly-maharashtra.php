...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-maharashtra"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Maharashtra - Me Bhi Neta</title>
    <meta name="Description" content="Available List of Members of Legislative Assembly Maharashtra at Me Bhi Neta and all kind of information."/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/maharashtra-me-bhi-neta.jpg" alt="member-of-legislative-assembly-maharashtra" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Maharashtra</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Sable, Shri Amar Shankar</td>
                                <td>BJP </td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Mahatme, Dr. Vikas</td>
                                <td>BJP  </td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Patil, Smt. Rajani</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Chidambaram, Shri P.</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>5</td>
                                <td>Kakade, Shri Sanjay Dattatraya </td>
                                <td>IND</td>
                            </tr>

                             <tr>
                                <td>6</td>
                                <td>Pawar, Shri Sharad </td>
                                <td>NCP</td>
                            </tr>

                             <tr>
                                <td>7</td>
                                <td>Tripathi, Shri D.P. </td>
                                <td>NCP</td>
                            </tr>

                            <tr>
                                <td>8</td>
                                <td>Sancheti, Shri Ajay </td>
                                <td>BJP</td>
                            </tr>

                             <tr>
                                <td>9</td>
                                <td>Dalwai, Shri Husain </td>
                                <td>INC </td>
                            </tr>

                            <tr>
                                <td>10</td>
                                <td>Raut, Shri Sanjay </td>
                                <td>SS</td>
                            </tr>

                             <tr>
                                <td>11</td>
                                <td>Patel, Shri Praful </td>
                                <td>NCP</td>
                            </tr>
                             ...
                             <tr>
                                <td>12</td>
                                <td>Sahasrabuddhe, Dr. Vinay P</td>
                                <td>BJP</td>
                            </tr>
                            ...
                            <tr>
                                <td>18</td>
                                <td>Dhoot, Shri Rajkumar</td>
                                <td>SS </td>
                            </tr>

                            <tr>
                                <td>19</td>
                                <td>Shukla, Shri Rajeev</td>
                                <td>INC</td>
                            </tr>

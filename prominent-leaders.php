...
<head>  
    ...
    <title>Prominent Leaders of India - Me Bhi Neta</title>
...
<section>
	...
	<img src="image/political-tools-Me-Bhi-Neta.jpg" alt="political-tools" class="img-responsive" style="margin-top: -20px; width: 1504px; height: 400px;">
...
<div class="container">
	<div class="col-md-8 col-xs-12">
		<h1 id="servicehead1">Prominent Leaders</h1><br/>

		<?php 
		function base64_url_encode($input) {
    return strtr(base64_encode($input), '+/=', '-_,');
		}
		$result=$mysqli->query("select * from prominent_leaders order by dats desc");
		while($row=mysqli_fetch_array($result))

		{?>


		<img src="uploadprominent/<?php echo $row['img']; ?>" class="img-responsive" width="750" height="250">
		<h2 id="servicehead2"><?php echo $row['title']; ?> </h2>
			<hr class="horizontal" style="border-bottom: 2px solid #4e2623;">
		<p style="max-height: 125px;overflow: hidden;" id="servicepara"><?php echo $row['description']; ?></p>

		<a href="prominent-leaders_readmore?ids=<?php echo base64_url_encode($row['id']); ?>" class="btn btn-default btn-lg" style="background-color:#4e2623; color: #fff; font-family: ' Lora', serif;">Learn More</a>
		<br><br>
	<?php } ?>
	...
	<div class="col-md-4 col-xs-12">
		...
		{?>
		<div class="view">
			<a href="prominent-leaders_readmore?ids=<?php echo base64_url_encode($row['id']); ?>" style="text-decoration: none;color:#fff;"><p style="height: 120px;overflow: hidden;"> <?php echo $row['description']; ?> </a></p>
		</div>
	<?php } ?>

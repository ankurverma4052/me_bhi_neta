...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-odisha"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Odisha - Me Bhi Neta</title>
    <meta name="Description" content="Get to know the list of all the Members of Legislative Assembly Odisha (MLAs) at Me Bhi Neta and their constituencies and their partie"/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/odisha-me-bhi-neta.jpg" alt="member-of-legislative-assembly-odisha" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Odisha</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Tirkey, Shri Dilip Kumar</td>
                                <td>BJD </td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Deo, Shri A.U. Singh</td>
                                <td>BJD</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Biswal, Shri Ranjib</td>
                                <td>INC </td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Nekkanti, Shri Bhaskar Rao</td>
                                <td>BJD </td>
                            </tr>

                            <tr>
                                <td>5</td>
                                <td>Swain, Shri Narendra Kumar</td>
                                <td>BJD </td>
                            </tr>

                             <tr>
                                <td>6</td>
                                <td>Swamy, Shri A.V.</td>
                                <td>IND</td>
                            </tr>

                             <tr>
                                <td>7</td>
                                <td>Hembram, Smt. Sarojini </td>
                                <td>BJD</td>
                            </tr>

                            <tr>
                                <td>8</td>
                                <td>Deb, Shri Pratap Keshari </td>
                                <td>BJD</td>
                            </tr>

                             <tr>
                                <td>9</td>
                                <td>Acharya, Shri Prasanna</td>
                                <td>BJD</td>
                            </tr>

                            <tr>
                                <td>10</td>
                                <td>Mohanty, Shri Anubhav </td>
                                <td>BJD</td>
                            </tr>

...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-nominated"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Nominated - Me Bhi Neta</title>

    <meta name="Description" content="List of Members of Legislative Assembly National Capital Territory of Delhi available at Me Bhi Neta. If you know about Me Bhi Neta then visit us."/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/maharashtra-me-bhi-neta.jpg" alt="member-of-legislative-assembly-nominated" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Nominated</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Parasaran, Shri K</td>
                                <td>NOM </td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Jadhav, Dr. Narendra</td>
                                <td>NOM</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Suresh Gopi, Shri</td>
                                <td>BJP </td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Chhatrapati, Shri Sambhaji</td>
                                <td>BJP </td>
                            </tr>

                            <tr>
                                <td>5</td>
                                <td>Tendulkar, Shri Sachin Ramesh</td>
                                <td>NOM</td>
                            </tr>
                             ...
                             <tr>
                                <td>7</td>
                                <td>Tulsi, Shri K.T.S</td>
                                <td>NOM</td>
                            </tr>

                            <tr>
                                <td>8</td>
                                <td>Dasgupta, Shri Swapan</td>
                                <td>NOM</td>
                            </tr>

                             <tr>
                                <td>9</td>
                                <td>Kom, Smt. M.C. Mary</td>
                                <td>NOM</td>
                            </tr>

                            <tr>
                                <td>10</td>
                                <td>Ganguly, Smt. Roopa</td>
                                <td>BJP </td>
                            </tr>

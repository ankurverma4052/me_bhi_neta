...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-council"/>
...
<!Navigation end here!>
	...
	<section>
		...
		<img src="image/member-of-legislative-council-me-bhi-neta.jpg" alt="member-of-legislative-council" class="img-responsive" style="margin-top: -20px; width: 1504px; height: 400px;">
...
<div class="container">
	...
	<div class="col-md-8 col-xs-12">
		<h1 id="servicehead1">Member of Legislative council</h1>
			
			<div id="margin-line">
				</div> <br>
		<section id="servicepara">
			<p>The Vidhan Parishad or Legislative Council is the upper house in those states of India that have a bicameral legislature.  And these are <strong>Andhra Pradesh, Bihar, Jammu and Kashmir, Karnataka, Maharashtra, Telangana, and Uttar Pradesh.</strong></p>

			<div class="col-md-8">
				<table style="width:100%;">
						  <tr>
						    
						    <th colspan="3" style="background-color: #69332f; color: #ffffff;"><center>List of MLCs in India</center></th>
						  </tr>
						  <tr>
						    <td><a  href="member-of-legislative-council-andhra-pradesh" id="tab">Andhra Pradesh</a></td>
						    <td><a  href="member-of-legislative-council-bihar" id="tab">Bihar</a></td>
						    <td><a  href="member-of-legislative-council-jammu-kashmir" id="tab">Jammu Kashmir</a></td>
						  </tr>

						  	<tr>
							    <td><a  href="member-of-legislative-council-karnataka" id="tab">Karnataka</a></td>
							    <td><a  href="member-of-legislative-council-maharashtra" id="tab">Maharashtra</a></td>
							    <td><a  href="member-of-legislative-council-telangana" id="tab">Telangana</a></td>
						  	</tr>	

						  		<tr>
								    <td><a  href="member-of-legislative-council-uttar-pradesh" id="tab">Uttar Pradesh</a></td>
								    <td></td>
								    <td></td>
						  		</tr>

...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-karnataka"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Karnataka - Me Bhi Neta</title>
    <meta name="Description" content="If you Know about  Members of Legislative Assembly Karnataka Then you are at right place Me Bhi Neta."/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/karnataka-me-bhi-neta.jpg" alt="member-of-legislative-assembly-karnataka" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Karnataka</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Ramamurthy, Shri K.C.</td>
                                <td>INC </td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Reddy, Shri D. Kupendra</td>
                                <td>JD(S)</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Patil, Shri Basawaraj</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Chandrasekhar, Shri Rajeev</td>
                                <td>IND</td>
                            </tr>

                            <tr>
                                <td>5</td>
                                <td>Hariprasad, Shri B.K</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>6</td>
                                <td>Fernandes, Shri Oscar</td>
                                <td>INC </td>
                            </tr>

                            <tr>
                                <td>7</td>
                                <td>Nirmala Sitharaman, Smt.</td>
                                <td>BJP </td>
                            </tr>

                            <tr>
                                <td> 8</td>
                                <td>Gowda, Prof. M.V. Rajeev</td>
                                <td>RJD  </td>
                            </tr>

                            <tr>
                                <td>9 </td>
                                <td>Rangasayee Ramakrishna, Shri</td>
                                <td>JD(U) </td>
                            </tr>

                            <tr>
                                <td>10</td>
                                <td>Ramesh, Shri Jairam</td>
                                <td>JD(U) </td>
                            </tr>

                            <tr>
                                <td>11 </td>
                                <td>Sahani, Dr. Anil Kumar </td>
                                <td>JD(U) </td>
                            </tr>

                            <tr>
                                <td>12</td>
                                <td>Thakur, Shri Ram Nath </td>
                                <td>JD(U) </td>
                            </tr>

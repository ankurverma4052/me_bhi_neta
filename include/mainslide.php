...
?>
   <aside data-mcs-theme="minimal-dark" style="background-image: url(build/images/backgrounds/11.jpg)" class="main-sidebar mCustomScrollbar">
        <div class="user">
          <div id="esp-user-profile" data-percent="65" style="height: 130px; width: 130px; line-height: 100px; padding: 15px;" class="easy-pie-chart"> <?php echo '<img src="uploads/'.$image.'" alt="" class="avatar img-circle">';?> <span class="status bg-success"></span></div>
          <h4 class="fs-16 text-muted mt-15 mb-5 fw-300"> <?php echo $user_name; ?> </h4>
          <!-- <p class="mb-0 text-muted">Designer</p> -->
        </div>
        <ul class="list-unstyled navigation mb-0">
          <li class="sidebar-category">Main</li>
          <li class="panel"><a  href="admin"  class="bubble active collapsed"><i class="ti-home"></i><span class="sidebar-title">Dashboard</span><span class="badge bg-danger">2</span></a>
          ...
          <li class="panel"><a href="write_blog"><i class="ti-panel"></i><span class="sidebar-title">write blog </span><span class="label label-outline label-danger">Updated</span></a></li>
          <?php if($_SESSION['utype']=='content_writer') { ?>
           <li class="panel"><a href="uupdate"><i class="ti-panel"></i><span class="sidebar-title">view/edit blog </span></a></li>
           <?php } ?>

          <?php if($_SESSION['utype']=='admin') { ?>
          <li class="panel"><a role="button" data-toggle="collapse" data-parent=".navigation" href="#collapse3" aria-expanded="false" aria-controls="collapse3" class="collapsed"><i class="ti-shopping-cart"></i><span class="sidebar-title">Admin Operation</span></a>
            <ul id="collapse3" class="list-unstyled collapse">
              <li><a href="createuser">Create User</a></li>
              <li><a href="product-list.html">Block user</a></li>
              <li><a href="approve">Approve Content</a></li>
         <?php } ?>



         <?php if($_SESSION['id']==15 || $_SESSION['id']==16 || $_SESSION['utype']=='admin') { ?>
               <li><a href="job_posting">Post A Job</a></li>
          <?php } ?>

            <?php if($_SESSION['utype']=='admin' || $_SESSION['id']==18 || $_SESSION['id']==19 || $_SESSION['id']==20 ) { ?>
               <li><a href="aspiring">Aspiring-Leader containt</a></li>
               <li><a href="prominent">prominent-Leader containt</a></li>
<?php } ?>
<?php if($_SESSION['utype']=='admin') { ?>
              <li><a href="liveup">live containt edit</a></li>

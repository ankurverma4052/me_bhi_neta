  ...
  <?php include("include/header.php") ?>
   ...
   <?php include("include/mainslide.php") ?>
        ...
        <div class="page-content container-fluid">
          <div class="widget">
            ...
            <div class="widget-body">
              <form id="form-vertical" method="post" novalidate="novalidate" action="prominent_insert.php" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="txttitle">Content Title</label>
                  <input id="contenttitle" type="text" name="contenttitle" placeholder="Enter content Title" data-rule-required="true" data-rule-rangelength="[10,200]" data-rule-text="true" class="form-control">
                </div>
              
                <div class="form-group">
                  <label for="textarea">Content Description</label>
    ...
    <strong>Success!</strong> Data inserted sucessfully.
                ...
                unset($_SESSION['suc']);
                ?>
                <button type="submit" name="btnaspiring" class="btn btn-raised btn-black">Submit</button>
              </form>
            </div>
        </div>

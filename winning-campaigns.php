...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/winning-campaigns"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Winning campaings | Best Campaigns of All time - Me Bhi Neta</title>
    <meta name="description" content="Me Bhi Neta is one of the unique Brand which is promoting Wining Campaingns and Best Marketing of Campaigns All time." />
...
<!Navigation end here!>
	...
	<section>
		...
		<img src="image/marketing-lists-me-bhi-neta.jpg" alt="winning-campaigns" class="img-responsive" style="margin-top: -20px; width: 1504px; height: 400px;">
...
<div class="container">
	...
	<div class="col-md-10 col-xs-12">
		<h1 id="servicehead1">Winning Campaigns </h1>
			
			<div id="margin-line">
				</div>
		<section id="servicepara">
			<p>It's essential that every election campaign and candidate should step out with an intention to win the election. This has to be a given at the outset of any campaign. And it becomes crucial to strategize each of your step in political campaigning. A candidate even if he/she is popular among the voters should not come in overconfidence and avoid the step of strategy making because taking a note from past political events, no matter how popular the candidate is, without a successful campaign, the chances of winning election drastically reduces.</p>

		<h2 id="servicehead2">Set Your Budget(Time + Money)</h2>
			<p>It becomes important while strategizing your political campaign that you first set your budget not only for money but also of time. You should be totally clear about how much money you can spend and how much time you have and then accordingly create a blueprint of the whole election campaign.</p>


		<h2 id="servicehead2">Start Online Ads</h2>
			<p>In the age of marketing, you can’t just rely on doing rallies as your election campaigning and posters and stickers. It is important nowadays to brand yourself on the internet as it is today’s lifeline, one has to promote itself in order to sustain in the world of tough competition. Especially in a country like India which has the maximum number of youths, online ads can play a crucial role in registering yourself in the mind of voters. So, start promoting yourself on the internet to maximize your accessibility.</p>


		<h2 id="servicehead2">Say Thank You</h2>
			<p>Once you have established your foot in the campaign, don’t forget that it’s all because of the people and hence it becomes important to say thank you. Whenever you appear in public and in your ads, don’t forget to thank people for your support to continue receiving them.</p>

			<p>Plenty of political campaigns make a lot of noise regarding the number of doors knocked on a particular night. But even a small loophole can drain down your whole election campaign. Why so? Because a successful campaign finally leading the candidate to victory depends on how much the door to door talks make sense on and is relevant to your voter, their area, and their issues.</p>

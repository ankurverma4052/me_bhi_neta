...
if($_SESSION['utype']=="content_writer")
 {
  header("location:userwrite_blog.php");
 }
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <?php include("include/header.php") ?>
   ...
   <?php include("include/mainslide.php") ?>
        ...
        <div class="page-content container-fluid">
          <div class="widget">
            ...
            <div class="widget-body">
              <form id="form-vertical" method="post" novalidate="novalidate" action="job_posting_insert" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="txttitle">Job Title</label>
                  <input id="jobtitle" type="text" name="jobtitle" placeholder="Enter Job Title" data-rule-required="true" data-rule-rangelength="[10,200]" data-rule-text="true" class="form-control">
                </div>

                 <div class="form-group">
                  <label for="position">Position</label>
                  <input id="position" type="text" name="position" placeholder="Enter Job position" data-rule-required="true" data-rule-rangelength="[3,200]" data-rule-text="true" class="form-control">
                </div>

                 <div class="form-group">
                  <label for="position">Key Skills</label>
                  <input id="keyskill" type="text" name="keyskill" placeholder="Enter key skills" data-rule-required="true" data-rule-rangelength="[3,200]" data-rule-text="true" class="form-control">
                </div>
              
                <div class="form-group">
                  <label for="textarea">Job Description</label>
                  <textarea id="containt" name="containt" placeholder="write Containt" data-rule-required="true" data-rule-rangelength="[20,5000]" data-rule-text="true" class="form-control"></textarea>
                </div>
               
                <div class="form-group">
                  <label for="txttitle">Salary</label>
                  <input id="salary" type="text" name="salary" placeholder="Enter Salary" data-rule-required="true" data-rule-rangelength="[2,200]" data-rule-text="true" class="form-control">
                </div>

                <div class="form-group">
                  <label for="exprience">Experience</label>
                  <input id="exprience" type="text" name="exprience" placeholder="Enter Title" data-rule-required="true" data-rule-rangelength="[1,6]" data-rule-text="true" class="form-control">
                </div>


                 <div class="form-group">
                  <label for="location">Location</label>
                  <input id="location" type="text" name="location" placeholder="Enter Location" data-rule-required="true" data-rule-rangelength="[1,60]" data-rule-text="true" class="form-control">
                </div>

                <div class="form-group">
                  <label for="opening">Opening</label>
                  <input id="opening" type="text" name="opening" placeholder="Enter number of opening" data-rule-required="true" data-rule-rangelength="[1,60]" data-rule-text="true" class="form-control">
                </div>
    ...
    <strong>Success!</strong> Data inserted sucessfully.
                ...
                unset($_SESSION['suc']);
                ?>
                <button type="submit" name="btnjobpost" class="btn btn-raised btn-black">Submit</button>
              </form>
            </div>
        </div>

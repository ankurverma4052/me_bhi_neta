...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-telangana"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Telangana - Me Bhi Neta</title>
    <meta name="Description" content="Get to know the list of all the MLA Members of Members of Legislative Assembly Telangana  available on Me Bhi Neta with their biodata"/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/telangana-me-bhi-neta.jpg" alt="member-of-legislative-assembly-telangana" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Telangana</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Arjunan, Shri K. R</td>
                                <td>AIADMK</td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Rathinavel, Shri T</td>
                                <td>AIADMK</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Vaithilingam, Shri R</td>
                                <td>AIADMK</td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Balasubramoniyan, Shri S.R</td>
                                <td>AIADMK</td>
                            </tr>

                            <tr>
                                <td>5</td>
                                <td>Bharathi, Shri R.S</td>
                                <td>DMK</td>
                            </tr>
                             ...
                             <tr>
                                <td>7</td>
                                <td>Siva, Shri Tiruchi</td>
                                <td>DMK</td>
                            </tr>

                            <tr>
                                <td>8</td>
                                <td>Selvaraj, Shri A. K</td>
                                <td>AIADMK</td>
                            </tr>

                             <tr>
                                <td>9</td>
                                <td>Vijila Sathyananth, Smt</td>
                                <td>AIADMK </td>
                            </tr>

                            <tr>
                                <td>10</td>
                                <td>Lakshmanan, Dr. R</td>
                                <td>AIADMK</td>
                            </tr>

                             <tr>
                                <td>11</td>
                                <td>Navaneethakrishnan, Shri A</td>
                                <td>AIADMK</td>
                            </tr>

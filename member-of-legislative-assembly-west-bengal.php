...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-west-bengal"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly West Bengal - Me Bhi Neta</title>
    <meta name="Description" content="Members of Legislative Assembly West Bengal Get to know the MLA list available on Me Bhi Neta with their biodata"/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/west-bengal-me-bhi-neta.jpg" alt="member-of-legislative-assembly-west-bengal" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly West Bengal</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Singh, Dr. Kanwar Deep</td>
                                <td>AITC  </td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Bhattacharya, Shri P.</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Gupta, Shri Vivek</td>
                                <td>AITC </td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Ghosh, Shri Kunal Kumar</td>
                                <td>AITC </td>
                            </tr>

                            <tr>
                                <td>5</td>
                                <td>Hassan, Shri Ahamed</td>
                                <td>AITC </td>
                            </tr>

                             <tr>
                                <td>6</td>
                                <td>Sen, Shri Tapan Kumar</td>
                                <td>CPI(M)</td>
                            </tr>

                             <tr>
                                <td>7</td>
                                <td>Chhetri, Smt. Shanta</td>
                                <td>AITC </td>
                            </tr>

                            <tr>
                                <td>8</td>
                                <td>Gupta, Shri Manish</td>
                                <td>AITC </td>
                            </tr>

                             <tr>
                                <td>9</td>
                                <td>O Brien, Shri Derek</td>
                                <td>AITC  </td>
                            </tr>

                            <tr>
                                <td>10</td>
                                <td>Ray, Shri Sukhendu Sekhar</td>
                                <td>AITC </td>
                            </tr>

                             <tr>
                                <td>11</td>
                                <td>Haque, Shri Md. Nadimul</td>
                                <td>AITC </td>
                            </tr>
                             ...
                             <tr>
                                <td>15</td>
                                <td>Bhunia, Shri Manas Ranjan</td>
                                <td>AITC </td>
                            </tr>

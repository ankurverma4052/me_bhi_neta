...
<head>  
    ...
    <link rel="canonical" href="https://www.mebhineta.com/member-of-legislative-assembly-madhya-pradesh"/>
    
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->  
    <title>Members of Legislative Assembly Madhya Pradesh - Me Bhi Neta</title>
    <meta name="Description" content="Available List of Members of Legislative Assembly Madhya Pradesh at Me Bhi Neta and all kind of information."/>
...
<!-- Navigation End -->
    ...
    <section>
        ...
        <img src="image/madhya-pradesh-me-bhi-neta.jpg" alt="member-of-legislative-assembly-madhya-pradesh" class="img-responsive" style="margin-top: -21px;">

    </section>

<div class="container">
    <div class="col-md-10 col-xs-12">
        <h1 id="servicehead1">Member of Legislative Assembly Madhya Pradesh</h1>
            <div id="margin-line">
                </div> <br>
        <section id="servicepara">
            <div class="col-md-10">
                    <table style="width:100%;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Uikey, Smt. Sampatiya</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>2</td>
                                <td>Akbar, Shri M. J.</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>3</td>
                                <td>Chaturvedi, Shri Satyavrat</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>4</td>
                                <td>Javadekar, Shri Prakash</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>5</td>
                                <td>Gehlot, Shri Thaawar Chand</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>6</td>
                                <td>Singh, Shri Digvijaya</td>
                                <td>INC</td>
                            </tr>

                            <tr>
                                <td>7</td>
                                <td>Ganesan, Shri La</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>8</td>
                                <td>Tankha, Shri Vivek K.</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>9</td>
                                <td>Jha, Shri Prabhat</td>
                                <td>BJP </td>

                            <tr>
                                <td>10</td>
                                <td>Jain, Shri Meghraj</td>
                                <td>BJP</td>
                            </tr>

                            <tr>
                                <td>11</td>
                                <td>Jatiya, Dr. Satyanarayan</td>
                                <td>BJP  </td>
                            </tr>

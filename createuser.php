        ...
        <div class="page-content container-fluid">
          <div class="widget">
            ...
            <div class="widget-body">
              <form id="form-vertical" method="post" novalidate="novalidate" action="userinsert" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="txttitle">User Name</label>
                  <input id="txttitle" type="text" name="username" placeholder="Enter User Name" data-rule-required="true" data-rule-rangelength="[5,15]" data-rule-text="true" class="form-control">
                </div>
                 <div class="form-group">
                  <label for="txttitle">Email Id</label>
                  <input id="emailid" type="text" name="emailid" placeholder="Enter Email Id" data-rule-required="true"  data-rule-text="true" class="form-control">
                </div>
                <div class="form-group">
                  <label for="txttitle">Password</label>
                  <input id="emailid" type="Password" name="Password" placeholder="Enter Password" data-rule-required="true" data-rule-rangelength="[5,20]" data-rule-text="true" class="form-control">
                </div>
                <div class="form-group">
                  <label for="txttitle">User Type</label>
